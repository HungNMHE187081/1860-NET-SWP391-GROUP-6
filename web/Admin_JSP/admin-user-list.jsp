                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tile">
                            <div class="tile-body">
                                <!-- Search form -->
                                <form action="${pageContext.request.contextPath}/admin/adminsearchuser" method="GET"
                                    class="mb-3" id="searchForm"
                                    style="position: relative; display: flex; align-items: center;">
                                    <div style="position: relative; flex-grow: 1;">
                                        <input type="text" class="form-control"
                                            placeholder="Enter FirstName, LastName, Email Address,...."
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${not empty user.roles}">
                                                            <a href="${pageContext.request.contextPath}/admin/removerole?userId=${user.userID}"
                                                                class="btn btn-danger">Remove Role</a>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <a href="${pageContext.request.contextPath}/admin/addrole?userId=${user.userID}"
                                                                class="btn btn-primary">Add Role</a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <a href="${pageContext.request.contextPath}/admin/adminedituser?userId=${user.userID}"
                                ...
                                <iframe allow="microphone;" width="350" height="430"
                                    src="https://console.dialogflow.com/api-client/demo/embedded/fc42984c-aea3-4572-b8bf-b5b964f581f7">
                                </iframe>
                            </div>
                        </div>
                    </div>
