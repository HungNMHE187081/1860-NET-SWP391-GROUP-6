                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/editprofile" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <!-- Profile Image Section -->
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <a class="btn btn-secondary" href="${pageContext.request.contextPath}/admin/viewprofile">
