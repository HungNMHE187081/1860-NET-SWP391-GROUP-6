                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-td-center">
                                            ...
                                            <c:if test="${reservation.hasRecord == false}">
                                                <button class="btn-primary btn-sm" type="button" title="Thêm" id="show-emp"><a href="${pageContext.request.contextPath}/staff/addmedicalrecord?staffID=${reservation.staffID}&reservationDate=${reservation.reservationDate}&reservationID=${reservation.reservationID}&childID=${childID}&childFirstName=${childFirstName}&childMiddleName=${childMiddleName}&childLastName=${childLastName}" title="Thêm lịch sử khám">
                            ...
                            <c:if test="${empty reservations}">
                                <tr>
                                    <td colspan="7" style="text-align: center;">Không có lịch đã khám</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
