        ...
        <div class="main-wrapper">
            ...
            <main>
                <section class="dashboard">
                    ...
                    <a href="${pageContext.request.contextPath}/staff/listprescription" class="back-link">Danh sách đơn thuốc</a>
                    ...
                    <div class="detail-container">
                        ...
                        <div class="detail-item">
                            <label>Tên trẻ: </label>
                            <span>${pres.childFirstName} ${pres.childMiddleName} ${pres.childLastName}</span>
                        </div>
                        <div class="detail-item">
                            <label>Tên khách hàng: </label>
                            <span>${pres.userFirstName} ${pres.userMiddleName} ${pres.userLastName}</span>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="action-buttons">
                            <a href="${pageContext.request.contextPath}/staff/updateprescription?id=${pres.prescriptionID}" class="btn edit-btn">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="${pageContext.request.contextPath}/staff/deleteprescription" method="post" style="display:inline;">
