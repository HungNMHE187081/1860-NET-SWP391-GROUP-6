<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <link href="${pageContext.request.contextPath}/css/jquery.timepicker.min.css" rel="stylesheet"
                type="text/css" />
            <link href="${pageContext.request.contextPath}/css/materialdesignicons.min.css" rel="stylesheet"
                type="text/css" />
            <link href="${pageContext.request.contextPath}/css/remixicon.css" rel="stylesheet" type="text/css" />
            ...
            <link href="${pageContext.request.contextPath}/css/tiny-slider.css" rel="stylesheet" type="text/css" />
            <link rel="stylesheet"
                href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=ecg_heart" />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-md-10">
                                <div class="reservation-form">
                                    ...
                                    <form action="${pageContext.request.contextPath}/customer/addreservation"
                                        method="post">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="serviceName"
                                                        value="${service.serviceName}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="ageLimit">Dành cho độ tuổi</label>
                                                    <input type="hidden" name="ageLimitID"
                                                        value="${ageLimit.ageLimitID}">
                                                    <input type="text" class="form-control" id="ageLimit"
                                                        value="${ageLimit.ageLimit}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="childName" name="childID" required>
                                                        ...
                                                        <c:forEach var="child" items="${children}">
                                                            <option value="${child.childID}">${child.firstName}
                                                                ${child.middleName} ${child.lastName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" class="form-control" id="startTime"
                                                        name="startTime" required min="08:00" max="17:00" step="1800">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <form action="${pageContext.request.contextPath}/customer/addtocart" method="GET"
                                        ...
                                        <button type="submit" onclick="return validateAndCopyFields()"
                                    ...
                                    <div class="form-group col-md-12" style="margin-top: 10px;">
                                        <a class="btn btn-cancel" href="${pageContext.request.contextPath}/homepage">Hủy
                                            bỏ</a>
                                    </div>
                                </div>
                            </div>
