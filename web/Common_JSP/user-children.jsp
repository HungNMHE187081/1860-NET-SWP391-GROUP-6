...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Tiny Tots - Danh sách con trẻ</title>
    ...
    <body>
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center">
                            <h3 class="sub-title mb-4 text-white title-dark">Con trẻ</h3>
                            <p class="para-desc mx-auto text-white-50">Chúng tôi mang đến cho bạn một giao diện về thông tin con cái của bạn, bạn có thể thay đổi thông tin nếu muốn ^.^</p>

                            <nav aria-label="breadcrumb" class="d-inline-block mt-3">
                                <ul class="breadcrumb bg-light rounded mb-0 py-1 px-2">
                                    <li class="breadcrumb-item"><a href="homepage">Childcare</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Thông tin trẻ</li>
                                </ul>
                            </nav>
                        </div>
                    </div><!--end col-->
        ...
        <section class="section py-5 bg-light">
            <div class="container">
                <div class="row g-4">
                    <c:forEach var="listChild" items="${listChild}">
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100 shadow-sm border-0 service-card">
                                <img src="${listChild.childImage}" class="card-img-top rounded-top" alt="${listChild.firstName} ${listChild.middleName} ${listChild.lastName}">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold text-primary">
                                       ${listChild.firstName} ${listChild.middleName} ${listChild.lastName}
                                    </h5>
                                ...
                                <div class="card-footer bg-transparent border-top-0">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="text-success fw-bold small">
                                            ...
                                            <fmt:formatDate value='${listChild.dateOfBirth}' pattern='dd-MM-yyyy' />
                                        </span>
