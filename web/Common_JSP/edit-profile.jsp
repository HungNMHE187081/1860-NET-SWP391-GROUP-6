            ...
            <main class="app-content">
                <div class="app-title">
                    <ul class="app-breadcrumb breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Chỉnh sửa hồ sơ</a></li>
                    </ul>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3 text-center">
                                            <div class="form-group">
                                                ...
                                                <div class="profile-img-container">
                                                    <img id="imagePreview" src="${userDetails.profileImage}"
                                                        alt="Image Preview" class="rounded-circle img-fluid">
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select class="form-control" name="gender" required>
                                                        <option value="Male" ${userDetails.gender=='Male' ? 'selected'
                                                            : '' }>Male</option>
                                                        <option value="Female" ${userDetails.gender=='Female'
                                                            ? 'selected' : '' }>Female</option>
                                                        <option value="Other" ${userDetails.gender=='Other' ? 'selected'
                                                            : '' }>Other</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select class="form-control" id="provinceID" name="provinceID"
                                                        ...
                                                        <c:forEach var="province" items="${provinces}">
                                                            <option value="${province.provinceID}"
                                                                ${userDetails.address.provinces.provinceID==province.provinceID
                                                                ? 'selected' : '' }>${province.provinceName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select class="form-control" id="districtSelect" name="districtID"
                                                        ...
                                                        <c:forEach var="district" items="${districts}">
                                                            <option value="${district.id}"
                                                                ${userDetails.address.district.districtID==district.id
                                                    ...
                                                    <select class="form-control" id="wardSelect" name="wardID">
                                                        ...
                                                        <c:forEach var="ward" items="${wards}">
                                                            <option value="${ward.id}"
                                                                ${userDetails.address.ward.wardID==ward.id ? 'selected'
                                                ...
                                                <div class="form-group col-md-12">
                                                    <button type="submit" class="btn btn-primary">Cập nhật hồ
                                                        sơ</button>
                                                </div>
                                            </div>
                                        </div>
