 ...
 * @author LENOVO
 */
public class StaffSearchNewReservationServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (keyword != null && !keyword.isEmpty() && timeOfDay != null && !timeOfDay.isEmpty()) {
            reservations = reservationDAO.searchReservationsByKeywordAndTimeOfDay(keyword, timeOfDay, false);
        } else if (keyword != null && !keyword.isEmpty()) {
            reservations = reservationDAO.searchReservationByKeyword(keyword, false);
        } else if (timeOfDay != null && !timeOfDay.isEmpty()) {
            reservations = reservationDAO.searchReservationsByTimeOfDay(timeOfDay, false);
        } else {
            reservations = reservationDAO.getReservationByIsExam(false);
        }
