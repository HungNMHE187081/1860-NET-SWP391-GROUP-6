...
public class ManagerEditProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ...
            request.getRequestDispatcher("/Manager_JSP/manager-edit-profile.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ...
            response.sendRedirect(request.getContextPath() + "/manager/viewprofile");
        } else {
            response.sendRedirect(request.getContextPath() + "/login");
        }
    }
